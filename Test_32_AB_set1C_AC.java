/**
	 ...
	 * Tests for Change Scenario 32: [A, B] -> set(1,C) -> [A, C]
	 * 
	 * @author CS 221
	 */
public class Test_32_AB_set1C_AC {
		...
		//****** Constants used in tests *****************
			// Name of class
			private static String CLASS_NAME = "Test_32_AB_set1C_AC"; 
			// Description of change scenario testing 
			private static final String testDescription = 
					"Change Scenario 32: [A, B] -> set(1,C) -> [A, C]"; 
			// Number of tests run 
			...
			private static final Character LAST = IndexedUnsortedListTests.C;	
		...
		public void initialize()
		{
			...
			// apply change 
			list.set(1,IndexedUnsortedListTests.C);
		}
