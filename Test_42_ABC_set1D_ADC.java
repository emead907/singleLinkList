	 ...
	 * Tests for Change Scenario 42: [A,B,C] -> SET(1,D) -> [A, D, C]
	 * 
	 * @author CS 221
	 */
public class Test_42_ABC_set1D_ADC {
		...
		//****** Constants used in tests *****************
			// Name of class
			private static String CLASS_NAME = "Test_42_ABC_set1D_ADC"; 
			// Description of change scenario testing 
			private static final String testDescription = 
					"Change Scenario 42: [A, B, C] -> set(1, D) -> [A, D, C]"; 
			// Number of tests run 
			...
			private static final Character SEC = IndexedUnsortedListTests.D;
		...
		public void initialize()
		{
			...
			// apply change 
			list.set(1, IndexedUnsortedListTests.D);
		}
