/**
	 ...
	 * Tests for Change Scenario 23: [A,B] -> ADD(1,C) -> [A, C, B]
	 * 
	 * @author CS 221
	 */
public class Test_23_AB_add1C_ACB {
		...
		//****** Constants used in tests *****************
			// Name of class
			private static String CLASS_NAME = "Test_23_AB_add1C_ACB"; 
			// Description of change scenario testing 
			private static final String testDescription = 
					"Change Scenario23: [A,B] -> ADD(1,C) -> [A, C, B]"; 
			// Number of tests run 
		...
		public void initialize()
		{
			...
			// apply change 
			list.add(1, IndexedUnsortedListTests.C);
		}
