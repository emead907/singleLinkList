/**
	 ...
	 * Tests for Change Scenario 10: [A] -> add(0,B) -> [B, A]
	 * 
	 * @author CS 221
	 */
public class Test_10_A_add0B_BA {
		...
		//****** Constants used in tests *****************
			// Name of class
			private static String CLASS_NAME = "Test_10_A_add(0, B)_BA"; 
			// Description of change scenario testing 
			private static final String testDescription = 
					"Change Scenario 10: [A] -> add(0, B) -> [B, A]"; 
			// Number of tests run 
			...
			private static final Character LAST = IndexedUnsortedListTests.A;	
		...
		public void initialize()
		{
			...
			// apply change 
			list.add(0, IndexedUnsortedListTests.B);
		}
