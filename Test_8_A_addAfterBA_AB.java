...
public class Test_8_A_addAfterBA_AB {
		...
		//****** Constants used in tests *****************
			// Name of class
			private static String CLASS_NAME = "Test_8_A_addAfterBA_AB"; 
			// Description of change scenario testing 
			private static final String testDescription = 
					"Change Scenario 8: [A] -> addAfter(B, A) -> [A, B]"; 
			// Number of tests run 
		...
		public void initialize()
		{
			...
			// apply change 
			list.addAfter(IndexedUnsortedListTests.B, IndexedUnsortedListTests.A);
		}
