	 ...
	 * Tests for Change Scenario 19: [A,B] -> ADDAFTER(C,A) -> [A, C, B]
	 * 
	 * @author CS 221
	 * @author Emily Mead
	 */
public class Test_19_AB_addAfterCA_ACB {
		...
		//****** Constants used in tests *****************
			// Name of class
			private static String CLASS_NAME = "Test_19_AB_addAfterCA_ACB"; 
			// Description of change scenario testing 
			private static final String testDescription = 
					"Change Scenario19: [A,B] -> ADDAFTER(C,A) -> [A, C, B]"; 
			// Number of tests run 
			...
			private static final Character SEC = IndexedUnsortedListTests.C;
		...
		public void initialize()
		{
			...
			// apply change 
			list.addAfter(IndexedUnsortedListTests.C, IndexedUnsortedListTests.A);
		}
