/**
	 ...
	 * Tests for Change Scenario 22: [A,B] -> ADD(0,C) -> [C, A, B]
	 * 
	 * @author CS 221
	 */
public class Test_22_AB_add0C_CAB {
		...
		//****** Constants used in tests *****************
			// Name of class
			private static String CLASS_NAME = "Test_22_AB_add0C_CAB"; 
			// Description of change scenario testing 
			private static final String testDescription = 
					"Change Scenario 22: [A, B] -> add(0, C) -> [C, A, B]"; 
			// Number of tests run 
			...
			private static final Character SEC = IndexedUnsortedListTests.A;
		...
		public void initialize()
		{
			...
			// apply change 
			list.add(0, IndexedUnsortedListTests.C);
		}
