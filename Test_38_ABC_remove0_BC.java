 ...
 * Tests for Change Scenario 38: [A, B, C] -> remove(0) -> [B, C]
 * 
 * @author CS 221
 * @author Emily Mead
 */
public class Test_38_ABC_remove0_BC {
	...
	//****** Constants used in tests *****************
		// Name of class
		private static String CLASS_NAME = "Test_38_ABC_remove0_BC"; 
		// Description of change scenario testing 
		private static final String testDescription = 
				"Change Scenario 38: [A, B, C] -> remove(0) -> [B, C]"; 
		// Number of tests run 
