 ...
 * @author Emily Mead
 */
public class Test_37_ABC_removeC_AB {
	...
	//****** Constants used in tests *****************
		// Name of class
		private static String CLASS_NAME = "Test_37_ABC_removeC_AB"; 
		// Description of change scenario testing 
		private static final String testDescription = 
				"Change Scenario 37: [A, B, C] -> remove(C) -> [A, B]"; 
		// Number of tests run 
	...
	public void initialize()
	{
		...
		// apply change 
		list.remove(IndexedUnsortedListTests.C);
	}
