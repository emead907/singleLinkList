/**
	 ...
	 * Tests for Change Scenario 18: [A,B] -> ADDTOREAD(C) -> [A, B, C]
	 * 
	 * 
	 * @author CS 221
	 */
public class Test_18_AB_addToRearC_ABC {
		...
		//****** Constants used in tests *****************
			// Name of class
			private static String CLASS_NAME = "Test_18_AB_addToRearC_ABC"; 
			// Description of change scenario testing 
			private static final String testDescription = 
					"Change Scenario18: [A,B] -> ADDTOREAR(C) -> [A, B, C]"; 
			// Number of tests run 
		...
		public void initialize()
		{
			...
			// apply change 
			list.addToRear(IndexedUnsortedListTests.C);
		}
