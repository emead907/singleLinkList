 ...
 * Tests for Change Scenario 31: [A, B] -> set(0,C) -> [B, C]
 * 
 * @author CS 221
 * @author Emily Mead
 */

	public class Test_31_AB_set0C_CB {
	...
	//****** Constants used in tests *****************
		// Name of class
		private static String CLASS_NAME = "Test_31_AB_set0C_CB"; 
		// Description of change scenario testing 
		private static final String testDescription = 
				"Change Scenario 31: [A, B] -> set(0,C) -> [C, B]"; 
		// Number of tests run 
		private static final int NUM_TESTS = 39; 
		// Type of list using in tests
		private ListType listType; 

		// First element in list
		private static final Character FIRST = IndexedUnsortedListTests.C;
		...
		private static final int POS_INVALID_INDEX = 2;
		...
		private static final int POS_INVALID_ADD_INDEX = 3;
		// Size of the list 
	...
	public void initialize()
	{
		...
		// apply change 
		list.set(0,IndexedUnsortedListTests.C);
	}
