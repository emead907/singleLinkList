	 ...
	 * Tests for Change Scenario 20: [A,B] -> ADDAfter(CB) -> [A, B, C]
	 * 
	 * 
	 * @author CS 221
	 */
public class Test_20_AB_addAfterCB_ABC {
		...
		//****** Constants used in tests *****************
			// Name of class
			private static String CLASS_NAME = "Test_20_AB_addAfterCB_ABC"; 
			// Description of change scenario testing 
			private static final String testDescription = 
					"Change Scenario20: [A,B] -> ADDAFTER(CB) -> [A, B, C]"; 
			// Number of tests run 
		...
		public void initialize()
		{
			...
			// apply change 
			list.addAfter(IndexedUnsortedListTests.C, IndexedUnsortedListTests.B);
		}
